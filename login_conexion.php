...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $consulta = "SELECT e.id as id, e.nombres as nombres, e.usuario as usuario, e.cedula as cedula, r.rol as rol, e.correo as correo FROM empleados as e JOIN roles r on e.rol_id = r.id WHERE e.contrasena = ? AND e.usuario = ?";
